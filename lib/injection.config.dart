...
import 'application/data_collection/bloc/onboard_bloc.dart' as _i25;
import 'application/data_collection/data_collection_bloc.dart' as _i22;
import 'application/theme/theme_cubit.dart' as _i21;
import 'domain/auth/i_auth_facade.dart' as _i7;
import 'domain/auth/use_cases/auth_use_cases.dart' as _i19;
import 'domain/auth/use_cases/get_signed_in_user_use_case.dart' as _i23;
...
import 'domain/data/use_cases/get_user_data_use_case.dart' as _i24;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i22.DataCollectionBloc>(() => _i22.DataCollectionBloc(
          gh<_i20.SubmitUserDataUsecase>(),
          gh<_i14.SelectInterestsUseCase>(),
        ));
    gh.factory<_i23.GetSignedInUserUseCase>(
        () => _i23.GetSignedInUserUseCase(gh<_i7.IAuthFacade>()));
    gh.factory<_i24.GetUserDataUseCase>(
        () => _i24.GetUserDataUseCase(gh<_i9.IDatafacade>()));
    gh.factory<_i25.OnboardBloc>(
        () => _i25.OnboardBloc(gh<_i24.GetUserDataUseCase>()));
    gh.factory<_i26.SignInFormBloc>(() => _i26.SignInFormBloc(
          gh<_i19.RegisterWithEmailAndPasswordUseCase>(),
          gh<_i19.SignInWithEmailAndPasswordUseCase>(),
          gh<_i19.SignInWithGoogleUseCase>(),
        ));
