...
import 'domain/auth/use_cases/auth_use_cases.dart' as _i18;
...
import 'domain/auth/use_cases/sign_in_with_e_and_password_use_case.dart'
    as _i14;
import 'domain/auth/use_cases/sign_in_with_google_use_case.dart' as _i15;
import 'domain/auth/use_cases/sign_out_use_case.dart' as _i16;
import 'domain/data/i_data_facade.dart' as _i9;
import 'domain/data/use_cases/get_user_data_use_case.dart' as _i22;
import 'domain/data/use_cases/submit_user_data_use_case.dart' as _i19;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i14.SignInWithEmailAndPasswordUseCase>(
        () => _i14.SignInWithEmailAndPasswordUseCase(gh<_i7.IAuthFacade>()));
    gh.factory<_i15.SignInWithGoogleUseCase>(
        () => _i15.SignInWithGoogleUseCase(gh<_i7.IAuthFacade>()));
    gh.factory<_i16.SignOutUseCase>(
        () => _i16.SignOutUseCase(gh<_i7.IAuthFacade>()));
    gh.factory<_i17.SignUpFormBloc>(() => _i17.SignUpFormBloc(
          gh<_i18.SignInWithGoogleUseCase>(),
          gh<_i18.RegisterWithEmailAndPasswordUseCase>(),
          gh<_i18.SignInWithEmailAndPasswordUseCase>(),
        ));
    gh.factory<_i19.SubmitUserDataUsecase>(
        () => _i19.SubmitUserDataUsecase(gh<_i9.IDatafacade>()));
    gh.factory<_i20.DataCollectionBloc>(
        () => _i20.DataCollectionBloc(gh<_i19.SubmitUserDataUsecase>()));
    ...
    gh.factory<_i25.AuthBloc>(() => _i25.AuthBloc(
          gh<_i18.GetSignedInUserUseCase>(),
