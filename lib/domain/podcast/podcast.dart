// Copyright 2023 Kelvin Zawdi.@kzawadi All rights reserved.
...
class Podcast {
  ...
  factory Podcast.fromSearchResultItem(Item item) => Podcast(
        guid: item.guid ?? '',
        url: item.feedUrl ?? '',
        link: item.feedUrl,
  ...
  static Podcast fromMap(int key, Map<String, dynamic> podcast) {
    ...
    var sd = DateTime.now();
    var lastUpdated = DateTime(1971, 1);
  ...
  DateTime get lastUpdated => _lastUpdated ?? DateTime(1970, 1);
